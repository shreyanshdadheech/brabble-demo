        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm">
              ...
              <Link href={"/signup"} className="block transition-colors hover:text-primary"> SignUp</Link>
              <Link href={"/login"} className="block transition-colors hover:text-primary"> Login</Link>
    ...
    <p className="text-sm">Email: contact@nodence.com</p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t pt-8 text-center md:flex-row">
          <p className="text-sm text-muted-foreground">
            © 2025 brabble.ai All rights reserved.
          </p>
